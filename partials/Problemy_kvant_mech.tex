...
Podle obecné teorie relativity se v přítomnosti hmoty ohýbá časoprostor, zatímco nepřítomnost hmoty způsobuje plochý časoprostor. Problém vzniká v subatomárních měřítcích. Zde převládají kvantové fluktuace způsobené Heisenbergovým principem neurčitosti\footnote[3]{Podle Heisenbergova principu neurčitosti vznikají i v perfektním vakuu páry virtuálních částic (částice a antičástice), které se anihilují krátce po svém vzniku.}, jenž vedou k radikálně zvrásněnému časoprostoru v protikladu k plo\-chému časoprostoru obecné relativity. K dalším nesouladům patří:
\begin{itemize}
    \item Neschopnost obecné relativity řešit nekonečné zakřivení časoprostoru, způsobené hmotnými body. 
    \item Nereálnost a nelokálnost kvantové mechaniky (vysvětleny v kapitole 2).
\end{itemize}
