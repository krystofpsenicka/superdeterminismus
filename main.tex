...
\def\acknowledgements{%
  ...
  \vskip 2em%
    ...
    {Chtěl bych poděkovat vedoucí seminární práce Mgr. Ivaně Špilínkové za odborné vedení, pomoc, gramatickou kontrolu a rady při zpracování této práce.}
  }%
...
\input{partials/Protiargumenty.tex}
\input{partials/Vyhled.tex}

\input{partials/Zaver.tex}
